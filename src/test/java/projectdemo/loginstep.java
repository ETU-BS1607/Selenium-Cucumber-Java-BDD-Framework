...
import Pages.LoginPage;  // Import LoginPage from the pages package

public class loginstep {

	/*
	 * WebDriver driver = null; LoginPage loginPage; // Page object
	 * 
	 ...
	 * TimeUnit.SECONDS); driver.manage().timeouts().pageLoadTimeout(20,
	 * TimeUnit.SECONDS); }
	 * 
	 ...
	 * 
	 * driver.navigate().to(
	 * "https://practicetestautomation.com/practice-test-login/"); loginPage = new
	 * LoginPage(driver); // Initialize LoginPage object using PageFactory }
	 * 
	 * @When("user enters {string} and {string}") public void
	 * user_enters_username_and_password(String username, String password) throws
	 * InterruptedException { System.out.println("Input Username and Password");
	 * 
	 ...
	 * InterruptedException { System.out.println("Clicks on login button");
	 * 
	 * loginPage.clickLoginButton(); // Use the LoginPage method Thread.sleep(2000);
	 * }
	 * 
	 * @Then("user is navigated to the Logged In Successfully") public void
	 * user_is_navigated_to_the_logged_in_successfully() {
	 ...
	 * System.out.println("Login was successful"); } else {
